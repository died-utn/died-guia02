...
public class Hola2 {
	...
	/**
	 * Este método ejecuta la aplicación cuyo propósito será imprimir en consola el dia, mes y año actual.
	 * Luego sumarle 250 horas a dicha fecha e imprimir la fecha que será dentro de 250 horas.
	 * @param args
	 * 
	 */
	...
	public static void main(String[] args) {
		...
		System.out.println("Hola la fecha dentro de 300 horas sera "+dia+"/"+mes+"/"+anio);
